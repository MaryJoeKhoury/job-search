...
const SearchJob = (props) => (
  ...
  >
    <g fill="#0c9" data-name="Group 60">
      ...
      />
      <path
        d="M41.087 42.51a11.481 11.481 0 0 0 1.663-5.7A10.688 10.688 0 1 0 32.063 47.5a11.436 11.436 0 0 0 5.7-1.67l6.413 6.41 3.325-3.32Zm-9.024.23A5.935 5.935 0 1 1 38 36.81a5.877 5.877 0 0 1-5.937 5.93Z"
        data-name="Path 232"
      />
    </g>
  </svg>
