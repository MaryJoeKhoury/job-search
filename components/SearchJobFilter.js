...
const SearchJobFilter = () => {
  return (
    <div className="bg-white sm:p-4 p-2 w-min  font-Poppins xs:text-sm flex text-sm flex-row lg:gap-5 gap-1 rounded-2xl ">
      <form>
        <div className="flex flex-row items-center rounded-xl  sm:pl-2 sm:pr-8 sm:py-2 bg-grey  sm:gap-3 gap-1  p-2">
          <div className="w-4">
          ...
          <div>
            <input
              ...
              className="bg-grey sm:w-[175px] w-[125px] sm:text-[1rem] text-[11px] outline-none"
            />
          </div>
        </div>
      </form>
      <div className="flex flex-row items-center rounded-xl bg-grey  pl-2 sm:pr-14 py-2 pr-2 sm:gap-3 gap-1">
        <div className="w-4">
          <img src="/icons/location.svg" />
        </div>
        <div>
          <select
            className="outline-none bg-grey sm:text-[1rem] text-[11px] "
            select=""
          >
